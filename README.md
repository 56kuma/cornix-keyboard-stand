...
現在の版は、Scaniverse で 3D スキャンした Cornix LP のメッシュを参考に再設計した、短辺下向き収納用の 2 スロット型「Lattice Bento Dock」です。材料費を抑えつつ見た目を良くするため、台座・側壁・中央ディバイダーを格子状フレームにしています。
...
生成済み STL の外形は `74.2 x 129.3 x 55.0 mm` です。スロット上部内寸は `88.8 x 12.8 mm`、底部のはめ込み溝は `88.8 x 10.8 x 1.0 mm`、総クリアランスは `0.8 mm` です。
